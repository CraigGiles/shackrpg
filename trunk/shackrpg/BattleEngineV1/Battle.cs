...
namespace BattleEngineV1
{
    public class Battle
    {
        ...
        /// </summary>
        Rectangle
            rFullScreenBackground = new Rectangle(0,0,800,600),
        ...
        Rectangle
            ...
            rPlayerSprite = new Rectangle(575, 300, 35, 35),
        ...
        public void DrawBattle(GameTime gameTime)
        {
            ...
            // Draws the background             //rBattleScene
            spriteBatch.Draw(tBattleBackground, rFullScreenBackground, Color.White);
