...
namespace DummyProject.HelperClasses
{
    ...
    class InputHelper
    {
        ...
        static public bool NextBattleCommand = false;
        static public bool PreviousBattleCommand = false;
        ...
        static public void GetPlayerInput()
        {
            ...
            #region Battle Commands Menu
            if (curKeyboardState.IsKeyUp(Keys.Up) && curKeyboardState.IsKeyUp(Keys.Down))
            {
                PreviousBattleCommand = false;
                NextBattleCommand = false;
            }
            else if (curKeyboardState.IsKeyDown(Keys.Up) && prevKeyboardState.IsKeyUp(Keys.Up))
            {
                PreviousBattleCommand = true;
                NextBattleCommand = false;
            }
            else if (curKeyboardState.IsKeyDown(Keys.Down) && prevKeyboardState.IsKeyUp(Keys.Down))
            {
                PreviousBattleCommand = false;
                NextBattleCommand = true;
            }
